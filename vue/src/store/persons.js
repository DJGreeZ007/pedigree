...
const initialState = [
  {
    ...
    military: [
      {
        type: "Срочка", // Тип службы
        rank: "Командир", // Звание, должность
        startDate: '1649010000', // Дата начала службы
        endDate: '1649010000', // Дата завершения службы
        description: "зп получал" // Описание
      }
    ],
    militaries: [
      {
    ...
    weddings: [
      {
        partnerId: '2', // id партнера
        startDate: '1649010000', // Дата заключения договора
        endDate: '1649010000', // Дата расторжения брака
      }
    ],
